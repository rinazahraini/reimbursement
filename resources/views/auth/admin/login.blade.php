    ...
    <div class="w-full px-4 mx-auto leading-10 text-center md:px-4 lg:px-6 max-w-7xl">
        <div class="box-border flex flex-col flex-wrap items-center justify-between text-indigo-900 md:flex-row">
            ...
            <div class="relative px-4 mt-2 font-medium leading-10 md:flex-grow-0 md:flex-shrink-0 md:mt-0 md:text-right lg:flex-grow-0 lg:flex-shrink-0">
                <a href="{{route('home')}}" class="box-border inline-block mx-5 text-right text-indigo-900 no-underline bg-transparent cursor-pointer hover:text-blue-700 focus:no-underline">
                    Home
                </a>
                <a href="{{route('status')}}" class="box-border inline-block mx-5 text-right text-indigo-900 no-underline bg-transparent cursor-pointer hover:text-blue-700 focus:no-underline">
                    Status
                </a>
            </div>
        </div>
...
<section class="relative flex items-center justify-center w-full h-full bg-white">
    ...
    <div class="flex items-center justify-center w-full h-full px-8 py-32 lg:w-3/4 lg:px-0">
        <div class="w-full max-w-lg mx-auto">
            ...
            <h1 class="text-gray-600 font-medium text-2xl border-b border-gray-300 pb-2.5 mb-2.5">Login Admin Account</h1>
            <p class="mb-10 text-gray-500">Login Admin Account<a href="#_" class="ml-1 font-medium text-blue-600"></a></p>
            <form method="POST">
                @csrf
